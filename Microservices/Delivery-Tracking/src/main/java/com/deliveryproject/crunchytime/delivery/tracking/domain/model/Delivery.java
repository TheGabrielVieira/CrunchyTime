package com.deliveryproject.crunchytime.delivery.tracking.domain.model;

import com.deliveryproject.crunchytime.delivery.tracking.domain.exception.DomainException;
import lombok.*;
...
public class Delivery {
    ...
    private void changeItemQuantity(UUID itemId, int quantity) {
